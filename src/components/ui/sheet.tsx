...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-card text-card-foreground border-border p-6 shadow-2xl shadow-secondary/20 transition ease-in-out data-[state=closed]:duration-300 data-[state=open]:duration-500 data-[state=open]:animate-in data-[state=closed]:animate-out",
  {
    variants: {
      side: {
